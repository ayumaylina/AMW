...
public class PostDataFromExcel {
	...
	public void befTest()
	{
		...
		req = new JSONObject();
		//String excelPath = "n.data/";
		String excelPath = "C:\\nexsoft\\training\\AMW\\AMW\\AMW\\data\\DataDriven.xlsx";
		//D:\\aaaa\\
	...
	public void testPost(String fName, String lName, String alamat)
	{		
		req.put("first_name",fName);
		req.put("last_name",lName);
		req.put("alamat",alamat);
